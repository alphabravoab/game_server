...
const attackRow1 = Array.apply(null, Array(3)).map(function () { return Math.floor(Math.random() * 50 % 50); });
const attackRow2 = Array.apply(null, Array(3)).map(function () { return Math.floor(Math.random() * 50 % 50); });
const attackRow3 = Array.apply(null, Array(3)).map(function () { return Math.floor(Math.random() * 50 % 50); });
const attackBoard = [attackRow1, attackRow2, attackRow3];
...
__decorate([
    typeorm_1.Column('json', { default: attackBoard }),
...
__decorate([
    typeorm_1.Column('int', { default: 100 }),
    __metadata("design:type", Number)
